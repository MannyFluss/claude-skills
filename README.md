...
These skills were originally created by [Matt Pocock](https://github.com/mattpocock) and sourced from [mattpocock/skills](https://github.com/mattpocock/skills). This repo is a personal fork with additions and modifications for my own workflow.

Big thank you to Matt for building and sharing these — they've genuinely changed how I work with Claude. If you ever stumble across this, know it's appreciated.
